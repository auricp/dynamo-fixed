...
class EnhancedMCPClient {
  ...
  async processQuery(query: string, stateless: boolean = true): Promise<string> {
...
export async function mcpProcessQuery(query: string, stateless: boolean = true): Promise<string> {
  if (!mcpClientInstance) {
